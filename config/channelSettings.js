...
const DEFAULT_CHANNEL_SETTINGS = {
  ...
  ai: {
    ...
    tone: "",
    cheatsheet: "",
    // Кто, кроме стримера и модераторов, вправе попросить бота замутить другого зрителя. Логины
    // без «@», в нижнем регистре. Список ведёт админ на сайте: заработать это право у бота больше
    // нечем - шкалы отношения нет, - а раздавать его по догадке нельзя.
    banRequesters: [],
  },
  responses: {
    busy: ["I am busy"],
